...
exports.upperCaseAll = function(string) {
...
exports.nwe = function (filename) {
      return filename.substring(0,(filename.length - (("." + filename.split('.').pop()).length)));
